...
! ==========================================================================================================
      ...
      IF (AT%SPACE .NE. 'FFF') THEN
        WRITE(*,*) 'CALCAT: [WARNING] THE FIELD TO BE EVALUATED IS NOT IN FFF SPACE.'
...
! ==========================================================================================================
      ...
      IF (AT%SPACE .NE. 'PPP') THEN
        WRITE(*,*) 'CALCAT: [WARNING] THE FIELD TO BE EVALUATED IS NOT IN PPP SPACE.'
...
!$OMP END PARALLEL DO
      ...
      INTEG = 4.D0*PI*FINFO%ZLEN*FINFO%ELL2*AT%E(1,1,1)
...
!$OMP END PARALLEL DO
      ...
      INTEG(1) = 4.D0*PI*FINFO%ZLEN*FINFO%ELL2*AT%ER(1,1,1)
      INTEG(2) = 4.D0*PI*FINFO%ZLEN*FINFO%ELL2*AT%EP(1,1,1)
      INTEG(3) = 4.D0*PI*FINFO%ZLEN*FINFO%ELL2*AT%EZ(1,1,1)
...
! ==========================================================================================================
      ...
      IF (.NOT. ((I .EQ. FINFO%NRDIM) .AND. (J .EQ. FINFO%NPDIM) .AND. (K .EQ. FINFO%NZDIM))) THEN
        WRITE(*,*) 'MLOAD: [WARNING] FIELD SIZE INCOMPATIBLE.'
        WRITE(*,*) 'DIM1: FILE --> ', I, ', PROGRAM -->', FINFO%NRDIM
        WRITE(*,*) 'DIM2: FILE --> ', J, ', PROGRAM -->', FINFO%NPDIM
        WRITE(*,*) 'DIM3: FILE --> ', K, ', PROGRAM -->', FINFO%NZDIM
      ENDIF
      ...
      IF (.NOT. ((I .EQ. FINFO%NRCHOP) .AND. (J .EQ. FINFO%NPCHOP) .AND. (K .EQ. FINFO%NZCHOP))) THEN
        WRITE(*,*) 'MLOAD: [WARNING] CHOPPING LOCATION(S) INCONSISTENT.'
        WRITE(*,*) 'R.CHOP: FILE --> ', I, ', PROGRAM -->', FINFO%NRCHOP
        WRITE(*,*) 'P.CHOP: FILE --> ', J, ', PROGRAM -->', FINFO%NPCHOP
        WRITE(*,*) 'Z.CHOP: FILE --> ', K, ', PROGRAM -->', FINFO%NZCHOP
      ENDIF
      ...
      IF (.NOT. ((Z .EQ. FINFO%ZLEN) .AND. (L .EQ. FINFO%ELL))) THEN
        WRITE(*,*) 'MLOAD: [WARNING] ZLEN & ELL INCONSISTENT.'
        WRITE(*,*) 'ZLEN: FILE --> ', Z, ', PROGRAM -->', FINFO%ZLEN
        WRITE(*,*) 'ELL: FILE --> ', L, ', PROGRAM -->', FINFO%ELL
      ENDIF
...
! ==========================================================================================================
      ...
      IF (NPC .NE. FINFO%NPCHOP) WRITE(*,*) 'HORFFT: [WARNING] GLOBAL CHOP .NE. LOCAL CHOP IN PHI'
...
!$OMP END PARALLEL DO
        ...
        IF (.NOT. ALL(ABS(AE(:,NPC+1:,:)) .LT. 1.D-14)) THEN
          ! WRITE(*,*) 'HORFFT/F: [WARNING] RESIDUES IN THE REGION TO BE CHOPPED. EXPECT DATA LOSS..'
        ENDIF
      ...
      ELSE
        IF ((.NOT. (ALL(AIMAG(AE(:,1,:)) .LT. 1.D-14) .AND. ALL(AIMAG(AE(:,NPC,:)) .LT. 1.D-14))) .OR. &
          ...
          ! WRITE(*,*) 'HORFFT/B: [WARNING] UNNECESSARY NONZERO ENTRIES WILL LEAD TO RESIDUES.'
        ENDIF
...
! ==========================================================================================================
      ...
      IF (NRCS(1) .NE. FINFO%NRCHOP) WRITE(*,*) 'RTRANS: [WARNING] GLOBAL CHOP .NE. LOCAL CHOP IN R'
      IF (NPC .NE. FINFO%NPCHOP) WRITE(*,*) 'RTRANS: [WARNING] GLOBAL CHOP .NE. LOCAL CHOP IN PHI'
...
! ==========================================================================================================
      ...
      IF (NRCS(1) .NE. FINFO%NRCHOP) WRITE(*,*) 'VERFFT: [WARNING] GLOBAL CHOP .NE. LOCAL CHOP IN R'
