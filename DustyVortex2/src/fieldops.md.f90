...
! ==========================================================================================================
      ...
      IF (A%SPACE .NE. 'FFF') THEN  
        WRITE(*,*) 'DELSQP: [WARNING] INPUT SCALAR FIELD NOT IN FFF. TO FFF BEFORE OPERATION...'
        CALL TRANS(A, 'FFF')
      ENDIF
...
! ==========================================================================================================
      ...
      IF (A%SPACE .NE. 'FFF') THEN  
        WRITE(*,*) 'MULXP: [WARNING] INPUT SCALAR FIELD NOT IN FFF. TO FFF BEFORE OPERATION...'
        CALL TRANS(A, 'FFF')
      ENDIF
      ...
      IF (ABS(A%LN) .GT. 1.D-14) THEN
        WRITE(*,*) 'MULXP: [WARNING] INPUT HAS NONZERO LOG TERM. OPERATION MAY BE INACCURATE.'
      ENDIF
...
! ==========================================================================================================
      ...
      IF (A%SPACE .NE. 'FFF') THEN  
        WRITE(*,*) 'DIVXP: [WARNING] INPUT SCALAR FIELD NOT IN FFF. TO FFF BEFORE OPERATION...'
        CALL TRANS(A, 'FFF')
      ENDIF
      ...
      IF (ABS(A%LN) .GT. 1.D-14) THEN
        WRITE(*,*) 'DIVXP: [WARNING] INPUT HAS NONZERO LOG TERM. OPERATION MAY BE INACCURATE.'
      ENDIF
...
! ==========================================================================================================
      ...
      IF (A%SPACE .NE. 'FFF') THEN  
        WRITE(*,*) 'MULXM: [WARNING] INPUT SCALAR FIELD NOT IN FFF. TO FFF BEFORE OPERATION...'
        CALL TRANS(A, 'FFF')
      ENDIF
      ...
      IF (ABS(A%LN) .GT. 1.D-14) THEN
        WRITE(*,*) 'MULXM: [WARNING] INPUT HAS NONZERO LOG TERM. OPERATION MAY BE INACCURATE.'
      ENDIF
...
! ==========================================================================================================
      ...
      IF (A%SPACE .NE. 'FFF') THEN  
        WRITE(*,*) 'DIVXM: [WARNING] INPUT SCALAR FIELD NOT IN FFF. TO FFF BEFORE OPERATION...'
        CALL TRANS(A, 'FFF')
      ENDIF
      ...
      IF (ABS(A%LN) .GT. 1.D-14) THEN
        WRITE(*,*) 'DIVXM: [WARNING] INPUT HAS NONZERO LOG TERM. OPERATION MAY BE INACCURATE.'
      ENDIF
...
! ==========================================================================================================
      ...
      IF (A%SPACE .NE. 'FFF') THEN  
        WRITE(*,*) 'IDEL2: [WARNING] INPUT SCALAR FIELD NOT IN FFF. TO FFF BEFORE OPERATION...'
        CALL TRANS(A, 'FFF')
      ENDIF
      ...
      IF (ABS(A%LN) .GT. 1.D-14) THEN
        WRITE(*,*) 'IDEL2: [WARNING] INPUT HAS NONZERO LOG TERM. OPERATION MAY BE INACCURATE.'
      ENDIF
...
! ==========================================================================================================
      ...
      IF (ABS(ALP) .LT. 1.D-14) WRITE(*,*) 'HELM: [WARNING] ALP=0. WHY NOT USING DEL2(A) INSTEAD?'

      IF (A%SPACE .NE. 'FFF') THEN  
        WRITE(*,*) 'HELM: [WARNING] INPUT SCALAR FIELD NOT IN FFF. TO FFF BEFORE OPERATION...'
        CALL TRANS(A, 'FFF')
      ENDIF
...
! ==========================================================================================================
      ...
      IF (A%SPACE .NE. 'FFF') THEN
        WRITE(*,*) 'IHELM: [WARNING] INPUT SCALAR FIELD NOT IN FFF. TO FFF BEFORE OPERATION...'
        CALL TRANS(A, 'FFF')
      ENDIF
...
! ==========================================================================================================
      ...
      IF (A%SPACE .NE. 'FFF') THEN  
        WRITE(*,*) 'HELMP: [WARNING] INPUT SCALAR FIELD NOT IN FFF. TO FFF BEFORE OPERATION...'
        CALL TRANS(A, 'FFF')
      ENDIF
...
! ==========================================================================================================
      ...
      IF (A%SPACE .NE. 'FFF') THEN
        WRITE(*,*) 'IHELMP: [WARNING] INPUT SCALAR FIELD NOT IN FFF. TO FFF BEFORE OPERATION...'
        CALL TRANS(A, 'FFF')
      ENDIF
...
! [NOTES]:
! THIS SUBROUTINE IS ALMOST SIMILAR TO VERFFT IN FIELDGEN.MD, EXCEPT THAT IT ASSUMES THE FIELD TO BE IN THE
...
! ==========================================================================================================
      ...
      IF (NPC .NE. FINFO%NPCHOP) WRITE(*,*) 'VERFFT: [WARNING] GLOBAL CHOP .NE. LOCAL CHOP IN PHI'
...
!$OMP END PARALLEL DO
        ...
        IF (NZC .LE. FINFO%NZ-NZC+2) THEN
          IF (.NOT. ALL(ABS(AE(:,:,NZC+1:FINFO%NZ-NZC+1)) .LT. 1.D-14)) THEN
            ! WRITE(*,*) 'VERFFT/F: [WARNING] RESIDUES IN THE REGION TO BE CHOPPED. EXPECT DATA LOSS..'
          ENDIF
        ENDIF
      ...
      ELSE
        IF (NZC .LE. FINFO%NZ-NZC+2) THEN
          IF (.NOT. ALL(ABS(AE(:,:,NZC+1:FINFO%NZ-NZC+1)) .LT. 1.D-14)) THEN
            ! WRITE(*,*) 'VERFFT/B: [WARNING] UNNECESSARY NONZERO ENTRIES WILL LEAD TO RESIDUES.'
          ENDIF
        ENDIF
