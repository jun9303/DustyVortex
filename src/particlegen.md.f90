...
! ==========================================================================================================
      ...
      OPEN(UNIT=FU, FILE=TRIM(ADJUSTL(FN)), STATUS='UNKNOWN', FORM='FORMATTED', IOSTAT=STATUS)
      IF (STATUS .NE.0) STOP 'PSAVE: FAILED TO CREATE/OPEN A FILE.'

      WRITE(FU,'(A1)') 'P'                            ! SAVING PARTICLE ... 
      WRITE(FU,'(2ES24.15E3)') PINFO%D, PINFO%VOL     ! PARTICLE DIAM. & VOL.
      WRITE(FU,'(2ES24.15E3)') PINFO%DENS, PINFO%RLXT ! PARTICLE DENS. & RELAX. TIME
      WRITE(FU,'(2I15)') NP, ND                       ! # OF PARTICLES

      WRITE(FU,'(<ND>ES24.15E3)') ((PTCL%POS(I,N), I=1, ND), N=1, NP)
      WRITE(FU,'(<ND>ES24.15E3)') ((PTCL%VEL(I,N), I=1, ND), N=1, NP)
      WRITE(FU,'(<ND>ES24.15E3)') ((PTCL%ACC(I,N), I=1, ND), N=1, NP)
...
! ==========================================================================================================
      ...
      OPEN(UNIT=FU, FILE=TRIM(ADJUSTL(FN)), STATUS='OLD', FORM='FORMATTED', IOSTAT=STATUS)
      IF (STATUS .NE.0) STOP 'PLOAD: FAILED TO CREATE/OPEN A FILE.'

      READ(FU,'(A1)') ISP
      IF (ISP .NE. 'P') STOP 'PLOAD: PARTICLE EXPECTED.'

      READ(FU,'(2ES24.15E3)') D, V
      ...
      READ(FU,'(<ND>ES24.15E3)') ((PTCL%POS(I,N), I=1, ND), N=1, NP)
      READ(FU,'(<ND>ES24.15E3)') ((PTCL%VEL(I,N), I=1, ND), N=1, NP)
      READ(FU,'(<ND>ES24.15E3)') ((PTCL%ACC(I,N), I=1, ND), N=1, NP)
