...
! ==========================================================================================================
      ...
      ELSE ! NONZERO HYPERVISCOSITY
        PSIVIS = HELMP(PSI, FINFO%VISCPOW, 0.D0, (-1.D0)**(FINFO%VISCPOW/2+1)*FINFO%VISC/FINFO%VISCP)
        PSIVIS%E = PSIVIS%E * FINFO%VISCP
        CHIVIS = HELMP(CHI, FINFO%VISCPOW, 0.D0, (-1.D0)**(FINFO%VISCPOW/2+1)*FINFO%VISC/FINFO%VISCP)
...
! ==========================================================================================================
      ...
      ELSE ! F(K+1) = (1-DT*VISC*DEL2-DT*VISCP*DELP)^(-1) F(K+1/2)
        ...
        B = (-1.D0)**(FINFO%VISCPOW/2+1)*FINFO%VISC/FINFO%VISCP
        PSIH%LN = A*PSIH%LN
        PSIH%E = A*PSIH%E
