...
! ==========================================================================================================
      ...
      REAL(P8), PUBLIC, DIMENSION(:), ALLOCATABLE :: AK                   ! ACCESSIBLE AZIMUTHAL WAVENUMBERS
...
! ==========================================================================================================
      ...
      IF (IAND(NZIN, NZIN-1) .NE. 0) THEN
        IF (WARN_ON) WRITE(*,*) 'FOU_INIT: [WARN] 2^N PREFERABLE FOR NZ FOR EFFICIENCY.'
      ENDIF
