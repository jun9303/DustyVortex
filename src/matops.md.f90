...
! ==========================================================================================================
      ...
      IF (PRESENT(EL)) THEN
        ...
        ENDDO
      ELSE
        CALL ZGGEV('V', 'V', NI, W1, NI, W2, NI, AEIG, BEIG, VV, NI, ER, NI, WK, LW, RWK, INFO)
      ENDIF
...
! ==========================================================================================================
      ...
      ELSE
        CALL GEIG_CC(CMPLX(A), CMPLX(B), EV, ER)
      ENDIF
...
! ==========================================================================================================
      ...
      ELSE
        CALL GEIG_CR(A, EYE(SIZE(A, 1)), EV, ER)
      ENDIF
...
! ==========================================================================================================
      ...
      ELSE
        CALL GEIG_RR(A, EYE(SIZE(A, 1)), EV, ER)
      ENDIF
