...
! ==========================================================================================================
      ...
      TYPE, PUBLIC :: INPUT_PARAMS                                           ! INPUT.PARAMS
        INTEGER           :: NR, NP, NZ, NRCHOP, NPCHOP, NZCHOP, VISCPOW 
        REAL(P8)          :: ELL, ZLEN, VISC, VISCP

        INTEGER           :: NI, TOTN
        REAL(P8)          :: DT, TI, TOTT

        REAL(P8)          :: PTCRESP, PTCDENS

        CHARACTER(LEN=2)  :: PDISTTYPE
        REAL(P8)          :: XPC, YPC, ZPC, PSCALE, PINTENSITY
...
! ==========================================================================================================
      ...
      READ(FU,*) DUM; READ(FU,*) PARAMS%NRCHOP, PARAMS%NPCHOP, PARAMS%NZCHOP
      ...
      READ(FU,*) DUM; READ(FU,*) PARAMS%PTCRESP, PARAMS%PTCDENS
      READ(FU,*) DUM
      ...
      READ(FU,*) DUM; READ(FU,*) PARAMS%PSCALE, PARAMS%PINTENSITY
      READ(FU,*) DUM
